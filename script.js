...
`,
        ...
        content: `
<div><img prefix="https://www.facebook.com/" href="#" name="facebook" class="facebook" alt="Facebook" src="face.jpeg" title="Facebook" width="auto" height="32px">
      <img prefix="https://twitter.com/" href="#" name="twitter" class="twitter" alt="Twitter" src="twitter.png" title="Twitter"  width="auto" height="32px">
      <img prefix="https://instagram.com/" href="#" name="instagram" class="instagram" alt="Instagram" src="instagram.png" title="Instagram"  width="auto" height="32px">
      <img prefix="https://www.linkedin.com/" href="#" name="linkedin" class="linkedin" alt="LinkedIn" src="linkedin.png" title="LinkedIn"  width="auto" height="32px"></div>
      <style>
  .facebook-org {
    content: url('face.jpeg');
  ...
  .facebook-trans {
    content: url('facebook-trans.png');
    display: inline-block;
  }
  .twitter-trans {
    content: url('twitter-trans.png');
    display: inline-block;
  }
  .instagram-trans{
    content: url('instagram-trans.png');
    display: inline-block;
  }
  .linkedin-trans {
    content: url('linkedin-trans.png');
    display: inline-block;
  }
...
const myNewComponentTypes = editor => {
    ...
    editor.DomComponents.addType('social-item', {
        ...
        model: {
            ...
            init() {
                ...
                this.on('change:attributes:iconcolor', this.handleColorChange);
            },
            ...
            handleColorChange() {
                if (this.getClasses[2])
                    this.removeClass(this.getClasses()[2]);
                this.addClass(`${this.getAttributes().iconcolor}`);
            }
        }
    });
    editor.DomComponents.addType('facebook', {
        isComponent: el => el.name === 'facebook',
    ...
    editor.DomComponents.addType('twitter', {
        isComponent: el => el.name === 'twitter',
    ...
    editor.DomComponents.addType('instagram', {
        isComponent: el => el.name === 'instagram',
    ...
    editor.DomComponents.addType('linkedin', {
        isComponent: el => el.name === 'linkedin',
...
bodyEle.set('stylable', editor.getWrapper().get('stylable').concat(['width', 'padding', 'padding-top', 'padding-right', 'padding-bottom', 'padding-left']));
bodyEle.setStyle({ 'margin': '0 auto' });